...
public class PinEntryEditText extends AppCompatEditText {
    ...
    protected float mSpace = 14; //24 dp by default, space between the lines
    ...
    protected RectF[] mLineCoords; //背景外框
    protected float[] mCharBottom;//字体的bottom
    protected Paint mCharPaint;
    protected Paint mLastCharPaint;
    protected Paint mSingleCharPaint;
    protected Drawable mPinBackground;//画背景图的
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int colorFocused = isInEditMode() ? Color.GRAY : ContextCompat.getColor(context, R.color.color_999999);
        mColors[1] = colorFocused;

        int colorUnfocused = isInEditMode() ? Color.GRAY : ContextCompat.getColor(context, R.color.color_999999);
